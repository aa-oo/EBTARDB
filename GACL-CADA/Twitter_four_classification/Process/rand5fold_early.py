...
def load5foldData(obj,data_path,label_path,method):
    path = data_path
    label_path = label_path
    ...
    if 'Twitter' in obj and method==0:
        ...
        fold0_x_test.extend(T[0:leng3]) 
        fold0_x_test.extend(U[0:leng4]) 
        fold0_x_val.extend(NR[leng1:leng1+leng11]) 
        fold0_x_val.extend(F[leng2:leng2+leng21]) 
        fold0_x_val.extend(T[leng3:leng3+leng31]) 
        fold0_x_val.extend(U[leng4:leng4+leng41]) 
        fold0_x_train.extend(NR[leng1+leng11:]) 
        fold0_x_train.extend(F[:leng2+leng21:])
        fold0_x_train.extend(T[leng3+leng31:])
        fold0_x_train.extend(U[leng4+leng41:])

        fold1_x_train.extend(NR[0:leng1]) 
        fold1_x_train.extend(NR[leng1 * 2+leng11:]) 
        fold1_x_train.extend(F[0:leng2]) 
        fold1_x_train.extend(F[leng2 * 2+leng21:])
        fold1_x_train.extend(T[0:leng3])
        fold1_x_train.extend(T[leng3 * 2+leng31:])
        fold1_x_train.extend(U[0:leng4])
        fold1_x_train.extend(U[leng4 * 2+leng41:])
        fold1_x_test.extend(NR[leng1:leng1*2]) 
        fold1_x_test.extend(F[leng2:leng2*2])
        fold1_x_test.extend(T[leng3:leng3*2])
        fold1_x_test.extend(U[leng4:leng4*2])
        fold1_x_val.extend(NR[leng1*2:leng1*2+leng11]) 
        fold1_x_val.extend(F[leng2*2:leng2*2+leng21]) 
        fold1_x_val.extend(T[leng3*2:leng3*2+leng31]) 
        fold1_x_val.extend(U[leng4*2:leng4*2+leng41]) 

        fold2_x_train.extend(NR[0:leng1*2])
        fold2_x_train.extend(NR[leng1*3+leng11:])
        fold2_x_train.extend(F[0:leng2*2])
        fold2_x_train.extend(F[leng2*3+leng21:])
        fold2_x_train.extend(T[0:leng3*2])
        fold2_x_train.extend(T[leng3*3+leng31:])
        fold2_x_train.extend(U[0:leng4*2])
        fold2_x_train.extend(U[leng4*3+leng41:])
        fold2_x_test.extend(NR[leng1*2:leng1*3])
        fold2_x_test.extend(F[leng2*2:leng2*3])
        fold2_x_test.extend(T[leng3*2:leng3*3])
        fold2_x_test.extend(U[leng4*2:leng4*3])
        fold2_x_val.extend(NR[leng1*3:leng1*3+leng11]) 
        fold2_x_val.extend(F[leng2*3:leng2*3+leng21]) 
        fold2_x_val.extend(T[leng3*3:leng3*3+leng31]) 
        fold2_x_val.extend(U[leng4*3:leng4*3+leng41]) 

        fold3_x_train.extend(NR[0:leng1*3]) 
        fold3_x_train.extend(NR[leng1*4+leng11:])
        fold3_x_train.extend(F[0:leng2*3])
        fold3_x_train.extend(F[leng2*4+leng21:])
        fold3_x_train.extend(T[0:leng3*3])
        fold3_x_train.extend(T[leng3*4+leng31:])
        fold3_x_train.extend(U[0:leng4*3])
        fold3_x_train.extend(U[leng4*4+leng41:])
        fold3_x_test.extend(NR[leng1*3:leng1*4])
        fold3_x_test.extend(F[leng2*3:leng2*4])
        fold3_x_test.extend(T[leng3*3:leng3*4])
        fold3_x_test.extend(U[leng4*3:leng4*4])
        fold3_x_val.extend(NR[leng1*4:leng1*4+leng11]) 
        fold3_x_val.extend(F[leng2*4:leng2*4+leng21]) 
        fold3_x_val.extend(T[leng3*4:leng3*4+leng31]) 
        fold3_x_val.extend(U[leng4*4:leng4*4+leng41]) 
        

        fold4_x_train.extend(NR[leng11:leng1*4])
        fold4_x_train.extend(NR[leng1*5:])
        fold4_x_train.extend(F[leng21:leng2*4])
        fold4_x_train.extend(F[leng2*5:])
        fold4_x_train.extend(T[leng31:leng3*4])
        fold4_x_train.extend(T[leng3*5:])
        fold4_x_train.extend(U[leng41:leng4*4])
        fold4_x_train.extend(U[leng4*5:])
        fold4_x_test.extend(NR[leng1*4:leng1*5])
        fold4_x_test.extend(F[leng2*4:leng2*5])
        fold4_x_test.extend(T[leng3*4:leng3*5])
        fold4_x_test.extend(U[leng4*4:leng4*5])
        fold4_x_val.extend(NR[0:leng11]) 
        fold4_x_val.extend(F[0:leng21]) 
        fold4_x_val.extend(T[0:leng31]) 
        fold4_x_val.extend(U[0:leng41]) 
    ...
    elif 'Twitter' in obj and method==6:
        labelPath = os.path.join(label_path)
        t_path = path
        file_list = os.listdir(t_path)
        print('The len of file_list: ', len(file_list))
