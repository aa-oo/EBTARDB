...
from evaluate import evaluationclass, evaluation4class
...
class CNN_Fusion(nn.Module):
    def __init__(self, args, W):
        ...
        self.class_classifier.add_module('c_fc1', nn.Linear(self.hidden_size, self.C))   
...
def main(args,seed):
    ...
    validation_dataset = Rumor_data(test)
