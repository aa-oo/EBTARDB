...
def load5foldDataP(obj,method):
    ...
    if obj == "Pheme" and method==0:
        ...
        label_path = '../data/Pheme_label_All.txt'
        ...
        # json_path='../data/pheme_label.json'
        # r=0
        # n=0
        # with open(json_path, encoding='utf-8') as f:
        #     json_inf = json.load(f)
        # for x in fold0_x_100_train:
        #     if json_inf[x]=='rumor':
        #         r+=1
        #     elif json_inf[x]=='non-rumor':
        #         n+=1
        # print(r,n)
        # r=0
        # n=0
    ...
    elif obj == "Pheme" and method==5:
        label_path = '../../GACL-CADA/PHEME_two_classification/data/pheme/Pheme_label_All.txt'
        labelPath = os.path.join(label_path)
        train_names=['ferguson','ebolaessien','ottawashooting','princetoronto','gurlitt','sydneysiege']
        test_names=['charliehebdo']
